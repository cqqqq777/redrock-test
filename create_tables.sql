...
create table users(
                      ...
                      `head_portrait` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  COMMENT '头像',
                      `background_img` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  COMMENT '背景',
                      primary key (id),
