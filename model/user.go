...
type ParamLoginByVerificationUser struct {
	Email        string `json:"email" binding:"required"`
	Verification int64  `json:"verification" binding:"required"`
}
...
type User struct {
	...
	HeadPortrait  string    `json:"headPortrait" db:"head_portrait"`
	BackgroundImg string    `json:"backgroundImg" db:"background_img"`
